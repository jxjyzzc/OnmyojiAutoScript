...
class GameUiAssets: 
	...
	# 六道之门 
	I_EXPLORATION_GOTO_SIX_GATES = RuleImage(roi_front=(838,640,60,49), roi_back=(793,632,143,66), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_six_gates.png")
	# 器灵 
	...
	# 斗技 
	I_CHECK_DUEL = RuleImage(roi_front=(1069,626,50,53), roi_back=(1031,592,106,101), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_duel.png")
	# description 
