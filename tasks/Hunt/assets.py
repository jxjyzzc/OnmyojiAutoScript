...
class HuntAssets: 
	...
	# Image Rule Assets
	# 麒麟的挑战 
	I_KIRIN_CHALLAGE = RuleImage(roi_front=(1090,597,94,59), roi_back=(1090,597,94,59), threshold=0.8, method="Template matching", file="./tasks/Hunt/kirin/kirin_kirin_challage.png")
	# 集合 
